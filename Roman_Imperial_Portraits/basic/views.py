...
class BasicDetails(DetailView):
    """Extension of the normal DetailView class for BASIC"""
        ...
        if self.checkAuthentication(request):
            ...
            if self.action == "":
                ...
                if self.dtype != "":
                    ...
                    sDbName = "ripd_{}_{}.{}".format(modelname, obj_id, extension)
                    sContentType = ""
                    if self.dtype == "csv":
                        ...
                        sDbName = "ripd_{}_{}.svg".format(modelname, obj_id)
                        ...
                        if len(arPart) > 1:
                            ...
                            # Set the filename correctly
                            sDbName = "ripd_{}_{}.png".format(modelname, obj_id)
